		...
		super({
			materialize: () => {
				...
				const vertexPositions = cornerPairs.map(([xIndex, yIndex, zIndex], cornerIndex) => {
					return [
						extendLine([corners[xIndex][0], corners[cornerIndex][1], corners[cornerIndex][2]], corners[cornerIndex], -bevelRadius)[0] || increaseMagnitude(corners[cornerIndex][0], -bevelRadius),
						extendLine([corners[cornerIndex][0], corners[yIndex][1], corners[cornerIndex][2]], corners[cornerIndex], -bevelRadius)[1] || increaseMagnitude(corners[cornerIndex][1], -bevelRadius),
						extendLine([corners[cornerIndex][0], corners[cornerIndex][1], corners[zIndex][2]], corners[cornerIndex], -bevelRadius)[2] || increaseMagnitude(corners[cornerIndex][2], -bevelRadius),
					];
				});
				const useCorner = [
					[true, false, false],
